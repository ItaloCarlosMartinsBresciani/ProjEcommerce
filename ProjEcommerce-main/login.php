...
<?php
        ...
        //include "conexao.php";
        //$sql="SELECT * FROM usuario WHERE excluido ='false' and  ORDER BY idusuario";
        ...
        <center>
        <i class='far fa-user'></i> Nome:       <br><br>        
        <i class='fas fa-envelope-open-text'></i> Email:   <br><br>  
        <i class='fas fa-database'></i> CPF:                 <br> <br> 
        <i class='fas fa-map-marker-alt'></i> CEP:        <br> <br> 
        <i class='fas fa-mobile'></i> Telefone:                <br> <br> 
